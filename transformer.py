...
#         self.start_symbol = raise NotImplementedError("Add categorical conditionings here") nn.Parameter(
...
#         # condition is included in the signqture only for compatibility
#         # with the ConditionalTransformer class
